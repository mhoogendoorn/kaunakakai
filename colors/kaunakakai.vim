...
hi CursorLine        guifg=fg        guibg=#3e3d32   gui=none
...
hi Colorcolumn       guifg=fg        guibg=#3b3a32   gui=none
" TODO: tabline
...
hi Directory         guifg=#a6e22e   guibg=bg        gui=bold
...
hi StatusLine        guifg=fg        guibg=#3b3a32   gui=none
hi StatusLineNC    ctermfg=none    ctermbg=235     cterm=none
hi StatusLineNC      guifg=fg        guibg=#262722   gui=none
...
hi Question          guifg=#66d9ef   guibg=bg        gui=none
hi Title           ctermfg=203     ctermbg=none    cterm=none
hi Title             guifg=#ef5939   guibg=bg        gui=none
hi ModeMsg         ctermfg=185     ctermbg=none    cterm=none
hi ModeMsg           guifg=#e6db74   guibg=bg        gui=none
hi MoreMsg         ctermfg=185     ctermbg=none    cterm=none
hi MoreMsg           guifg=#e6db74   guibg=bg        gui=none
...
hi Visual            guifg=fg        guibg=#403d3d   gui=none
hi! link VisualNOS Visual
hi NonText         ctermfg=242     ctermbg=none    cterm=none
hi NonText           guifg=#75715e   guibg=bg        gui=none
...
hi SpecialKey        guifg=#75715e   guibg=bg        gui=italic

" Variable types
hi Constant        ctermfg=141     ctermbg=none    cterm=bold
hi Constant          guifg=#ae81ff   guibg=bg        gui=bold
...
hi Statement         guifg=#f92672   guibg=bg        gui=bold
hi Conditional     ctermfg=161     ctermbg=none    cterm=bold
hi Conditional       guifg=#f92672   guibg=bg        gui=bold
hi Repeat          ctermfg=161     ctermbg=none    cterm=bold
hi Repeat            guifg=#f92672   guibg=bg        gui=bold
...
hi SpecialComment    guifg=#7e8e91   guibg=bg        gui=bold
hi Debug           ctermfg=181     ctermbg=none    cterm=bold
hi Debug             guifg=#bca3a3   guibg=bg        gui=bold
...
hi Macro             guifg=#c4be89   guibg=bg        gui=italic
hi PreCondit       ctermfg=112     ctermbg=none    cterm=bold
hi PreCondit         guifg=#a6e22e   guibg=bg        gui=bold
...
hi StorageClass      guifg=#fd971f   guibg=bg        gui=italic
...
hi DiffAdd           guifg=fg        guibg=#13354a   gui=none
...
hi DiffText          guifg=fg        guibg=#4c4745   gui=italic,bold
...
hi PmenuSbar         guifg=fg        guibg=#080808   gui=none
hi PmenuThumb      ctermfg=none    ctermbg=240     cterm=none
hi PmenuThumb        guifg=fg        guibg=#585858   gui=none

" Spelling
hi SpellBad        ctermfg=196     ctermbg=none    cterm=underline
hi SpellBad          guifg=fg        guibg=bg        gui=undercurl guisp=#ff0000
hi SpellCap        ctermfg=63      ctermbg=none    cterm=underline
hi SpellCap          guifg=fg        guibg=bg        gui=undercurl guisp=#7070f0
hi SpellLocal      ctermfg=87      ctermbg=none    cterm=underline
hi SpellLocal        guifg=fg        guibg=bg        gui=undercurl guisp=#70f0f0
hi SpellRare       ctermfg=231     ctermbg=none    cterm=underline
hi SpellRare         guifg=fg        guibg=bg        gui=undercurl guisp=#ffffff

" Specific settings
hi Conceal         ctermfg=165     ctermbg=bg      cterm=none
hi conceal           guifg=#d700ff   guibg=bg        gui=none
